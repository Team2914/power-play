...
public class BlueRear extends LinearOpMode {
    ...
    private void rotate90CW() {
        m_frontLeft.setTargetPosition(m_frontLeft.getCurrentPosition() + (360 * 2));
        m_backLeft.setTargetPosition(m_backLeft.getCurrentPosition() + (380 * 2));
        m_frontRight.setTargetPosition(m_frontRight.getCurrentPosition() - (430 * 2));
        m_backRight.setTargetPosition(m_backRight.getCurrentPosition() - (440 * 2));
    ...
    public void runOpMode() {
        ...
        while (!isStopRequested()) {
            ...
            /*driveInches(Config.ONE_TILE_INCHES * 2 + 1, 0);
            rotate45CW(1);
            driveInches(2, 2);
            setClawPos(1, 3);
            rotateFaceConeStorage(4);
            driveInches(Config.ONE_TILE_INCHES - 3, 5);*/
